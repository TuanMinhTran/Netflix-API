...
add column src_path varchar(30),
add column title varchar(40) character set utf8mb4;

insert into categories( cate_name, src_path, title ) values 
("Trang Chủ", "/browse", "Danh Sách Phim"),
("Phim T.hình", "/browse/tvshows", "Danh Sách Phim T.hình"),
("Phim Kinh dị", "/browse/films", "Danh Sách Phim Kinh dị");
insert into categories( cate_name, src_path, title ) values 
("Phim Việt Nam", "/browse/filmsvn", "Danh Sách Phim VN");

insert into categories( cate_name, src_path, title ) values 
("Phim Hài", "/browse/phimhai", "Danh Sách Phim Hài");
...
ALTER TABLE movies MODIFY title VARCHAR(50) CHARACTER SET utf8mb4;
...
"Rừng Thiên Nước Độc", "tam thoi chua co", 2024, "25 sec", 3, "https://i.vimeocdn.com/video/1914275021-7f0d57f215b9988962b969
...
"Sau Bình Minh", "tam thoi chua co", 2024, "54 sec", 3, "https://i.vimeocdn.com/video/1914274996-56ac2da25e233bd6bbe879980538
...
"Khu Nghỉ Dưỡng", "tam thoi chua co", 2024, "31 sec", 3, "https://i.vimeocdn.com/video/1914274927-9135f942fb5f539e276f55bae6f
...
"Thành Phố Tuyết", "tam thoi chua co", 2024, "21 sec", 3, "https://i.vimeocdn.com/video/1914274895-5ba8ac59752c7cacac646c09b5
...
"Dê Cụ 1", "tam thoi chua co", 2024, "1p2", 3, "https://i.vimeocdn.com/video/1914274814-ce55d4289d718110f37dde813354acfd6
...
"Dê Cụ 2", "tam thoi chua co", 2024, "1p57", 3, "https://i.vimeocdn.com/video/1914274814-ce55d4289d718110f37dde813354acfd6
19a479a524f8b50b5c1780807bf4dbb-d_640x360"),
...
"Biển", "tam thoi chua co", 2024, "48 sec", 2, "https://i.vimeocdn.com/video/1914274715-db6cee5f248b3267b3ba237aab342d3f7de72
...
"Sa Mạc Đông Đúc", "tam thoi chua co", 2024, "40 sec", 2, "https://i.vimeocdn.com/video/1914274667-5da3d4cd1f2317cfb444991cf9
...
"Du Thuyền và Biển", "tam thoi chua co", 2024, "36 sec", 2, "https://i.vimeocdn.com/video/1914274667-5da3d4cd1f2317cfb444991cf9
3719dc4dc9625a61a543943e7ff9bfacea77ee-d_640x360"),
...
"Đất Rừng Phương Ấy", "tam thoi chua co", 2024, "38 sec", 2, "https://i.vimeocdn.com/video/1914274617-7a556a245edd50bff7d27cc816e89b173
...
insert into movies( url_movie, title, descriptions, premiere_year, runtime, category_id, url_thumbnail ) values
("https://firebasestorage.googleapis.com/v0/b/netflix-d2442.appspot.com/o/winter-snowy-forest.mp4?alt=media&token=a854463b-d827-4fb7-9962-0efa01090700", 
"Rừng Thiên Nước Độc", "tam thoi chua co", 2024, "25 sec", 4, "https://i.vimeocdn.com/video/1914275021-7f0d57f215b9988962b969
9fb3b133ce6192d98c58048f64fdfa0ff126c27338-d_640x360");
...
ALTER TABLE packages MODIFY pack_name VARCHAR(20) CHARACTER SET utf8mb4;

insert into packages ( pack_name, pack_price, quality, resolation) values 
("Di động",  "70000", "HD (720p)", "1280x720 pixel"),
("Cơ bản",  "108000", "Full HD (1080p)", "1920x1080 pixel"),
("Tiêu chuẩn",  "220000", "Ultra HD (4K)", "3840x2160 pixel"),
("Cao cấp",  "260000", "Full HD (1080p), Ultra HD (4K)", "1920x1080 pixel, 3840x2160 pixel");
...
ALTER TABLE devices
MODIFY device_1 VARCHAR(20) CHARACTER SET utf8mb4;
ALTER TABLE devices
MODIFY device_2 VARCHAR(20) CHARACTER SET utf8mb4;
ALTER TABLE devices
MODIFY device_3 VARCHAR(20) CHARACTER SET utf8mb4;
ALTER TABLE devices
MODIFY device_4 VARCHAR(20) CHARACTER SET utf8mb4;

insert into devices ( device_1, device_2, device_3, device_4) values 
("Điện thoại", "Máy tính bảng", null, null),
("Điện thoại", "Máy tính bảng", "Máy tính", null),
("Điện thoại", "Máy tính bảng", "Máy tính", null),
("Điện thoại", "Máy tính bảng", "Máy tính", "TV");
...
SELECT
    p.id AS package_id, p.pack_name, p.pack_price, p.quality,p.resolation, d.id AS device_id, d.device_1, d.device_2, d.device_3, d.device_4
FROM packages p
JOIN package_device pd ON p.id = pd.package_id
JOIN devices d ON pd.device_id = d.id;

SELECT u.*, p.pack_name, p.pack_price, p.quality, p.resolation
FROM users u
